...
extern char *getScannerList();  // Command port frontend to the internalGetScannerList function
extern void *doScanningOperation(void *); //command port frontend to the internalDoScanningOperation function
