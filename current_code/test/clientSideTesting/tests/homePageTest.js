  ...
  document.cookie = "requested_lang="+expires+"; path=/";
    ...
    // ------------------------------------------------
		asyncTest('Page presented in broswers native language', 2, function() {
    ...
    // ------------------------------------------------
		asyncTest('Select Test Lang', 2, function() {
    ...
    // ------------------------------------------------
		asyncTest('Select German', 2, function() {
      console.log("1. Running: update language dropdown");
    ...
    // ------------------------------------------------
		asyncTest('Reset language dropdown', 1, function() {
      // delete any language cookie that may be present
      var date = new Date();
      date.setTime(date.getTime()-(24*60*60*1000));
      var expires = "; expires="+date.toGMTString();
